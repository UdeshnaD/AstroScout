...
const guidance: Partial<Record<EventTarget, ObjectGuidance>> = {
  ...
  mercury: {
    ...
    starter: "Mercury stays close to the Sun, so it is usually briefly seen in bright twilights.",
  ...
  mars: {
    beginner: "Some experience helpful", astrophotography: "Challenging",
    starter: "A bright, distinctively reddish point when well placed; surface detail requires magnification and steady skies.",
  ...
  saturn: {
    ...
    starter: "Saturn shines with a yellow-gold, telescopes make the rings visible, with the ring appearance changing as their tilt varies.",
    equipment: "Visible to the unaided eye, but use a telescope to distinguish the rings.",
    photography: "To see the rings, steady air, accurate focus, and planetary imaging techniques are ideal.",
    sourceLabel: "NASA skywatching FAQ",
    sourceUrl: "https://science.nasa.gov/skywatching/faq/",
  },
  uranus: {
    beginner: "Advanced target", astrophotography: "Challenging",
    starter: "Uranus looks like a very faint blue-green point and mainly visible in very dark locaions.",
  ...
  neptune: {
    beginner: "Advanced target", astrophotography: "Challenging",
    starter: "Neptune is too faint for unaided-eye viewing and resembles a dim star at low magnification, and a deep blue at higher magnification.",
